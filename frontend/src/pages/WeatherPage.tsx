          ...
          <AnimatedSection custom={1} className="mb-6">
            ...
            <div className="flex overflow-x-auto space-x-3 pb-2 -mx-4 px-4 snap-x hide-scrollbar">
              {forecast.map((day, idx) => (
                ...
                >
                  <span className="text-sm font-medium text-[#546E7A] mb-1">{getDayLabel(day.date, idx)}</span>
                  ...
                  <span className="text-xs text-blue-500 font-medium">{day.rainfall_mm}mm 🌧️</span>
                </motion.div>
              ))}
            </div>
          </AnimatedSection>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-xs font-noto text-text-secondary mb-0.5">
                        {getDayLabel(day.date, forecast.indexOf(day))}
                      </p>
                      <p className="text-sm text-[#1B2B1D] leading-relaxed">{day.farming_advisory}</p>
                    </div>
                  </div>
                ))}
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Tooltip
                    ...
                    formatter={((val: any) => [`${Number(val).toFixed(0)} mm`, 'Rainfall']) as any}
                  />
