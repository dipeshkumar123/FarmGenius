...
- Name: auth.spec.ts >> TC-AUTH-003: Valid phone + Terms checked → transitions to OTP step >> OTP boxes appear after successful phone submission
- Location: tests\e2e\auth.spec.ts:111:3
