...
- Name: chat.spec.ts >> TC-CHAT-003: Chat shows error when backend fails >> 500 from /chat — app falls back gracefully and shows a message
- Location: tests\e2e\chat.spec.ts:69:3
