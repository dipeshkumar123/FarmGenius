...
- Name: auth.spec.ts >> TC-AUTH-009: Protected routes redirect unauthenticated users to /login >> /dashboard redirects to /login when no token in localStorage
- Location: tests\e2e\auth.spec.ts:220:5
