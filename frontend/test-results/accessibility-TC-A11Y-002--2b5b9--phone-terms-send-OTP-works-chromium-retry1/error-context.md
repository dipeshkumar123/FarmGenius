...
- Name: accessibility.spec.ts >> TC-A11Y-002: Keyboard-only login flow reaches OTP step >> tab navigation through phone, terms, send OTP works
- Location: tests\e2e\accessibility.spec.ts:50:3
