...
- Name: chat.spec.ts >> TC-CHAT-001: Send a message and receive AI response >> user message appears and AI response bubble is shown
- Location: tests\e2e\chat.spec.ts:18:3
