...
- Name: responsive.spec.ts >> TC-RESP-001: Login page on mobile viewport (375 × 812) >> OTP boxes are usable on mobile after valid phone entry
- Location: tests\e2e\responsive.spec.ts:45:3
