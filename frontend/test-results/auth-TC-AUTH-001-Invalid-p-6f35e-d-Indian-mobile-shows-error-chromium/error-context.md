...
- Name: auth.spec.ts >> TC-AUTH-001: Invalid phone numbers show error toast, OTP step not reached >> phone starting with 1 (invalid Indian mobile) shows error
- Location: tests\e2e\auth.spec.ts:55:3
