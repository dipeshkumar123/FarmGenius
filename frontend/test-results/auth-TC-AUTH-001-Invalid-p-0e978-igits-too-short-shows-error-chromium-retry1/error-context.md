...
- Name: auth.spec.ts >> TC-AUTH-001: Invalid phone numbers show error toast, OTP step not reached >> phone with 5 digits (too short) shows error
- Location: tests\e2e\auth.spec.ts:73:3
